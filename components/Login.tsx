...
export default function LoginForm() {
  ...
  return (
    <section className="py-10 flex items-center justify-center bg-transparent font-sans">
      <div className="w-full max-w-md mx-auto p-8 sm:p-10 z-10">
        ...
        <form action={formAction} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="px-4 py-6 bg-gray-50 border-[1.5px] border-black focus-visible:ring-black"
            />
          </div>
          ...
          <div className="space-y-1.5 relative">
            ...
            <div className="relative">
              <Input
                ...
                className="px-4 py-6 bg-gray-50 border-[1.5px] border-black focus-visible:ring-black pr-12"
              />
              <button
                type="button"
          ...
          <Button
            type="submit"
            disabled={isPending}
            className="cursor-pointer w-full mt-2 text-xl py-6 bg-black hover:bg-black/90 text-white rounded-lg font-semibold"
          >
        ...
        <div className="or-separator max-w-sm mx-auto mt-8 mb-6">
          <span className="text-xl text-[#c6c9cd] px-3">OR</span>
        </div>
        ...
        <Button
          ...
          disabled={isLoading}
          className="w-full py-7 cursor-pointer border-[1.5px] border-black rounded-xl font-medium hover:bg-gray-100 text-base"
        >
          {isLoading ? (
